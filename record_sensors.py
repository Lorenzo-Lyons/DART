...
class record_input_and_sensor_data:
    def __init__(self, car_number):
        ...
        self.folder_name = 'Data_processing/Data/NEW_DATA_FOLDER/'
        ...
        file_name = self.rospack.get_path('platooning_utilities') + self.folder_name + self.file_name +'recording_'+ date_time_str + '.csv'
