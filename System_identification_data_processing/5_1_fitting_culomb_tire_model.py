...
plot_vicon_data,pacejka_tire_model,model_parameters,directly_measured_model_parameters,process_vicon_data_kinematics
...
pacejka_tire_model_obj = pacejka_tire_model(initial_guess,m_front_wheel,m_rear_wheel)
...
lateral_force_vec_front = pacejka_tire_model_obj.lateral_tire_force(alpha_f_plotting_front,d_t_f,c_t_f,b_t_f,m_front_wheel).detach().cpu().numpy()
...
lateral_force_vec_rear = pacejka_tire_model_obj.lateral_tire_force(alpha_r_plotting_rear,d_t_r,c_t_r,b_t_r,m_rear_wheel).detach().cpu().numpy()
