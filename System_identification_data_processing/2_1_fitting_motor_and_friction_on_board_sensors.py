from functions_for_data_processing import get_data, plot_raw_data, motor_and_friction_model,model_functions
...
motor_and_friction_model_obj = motor_and_friction_model(n_past_throttle)
